...
text = "Ishtirok etish uchun kanallarga obuna bo'ling:\n" + "\n".join(CHANNELS)
...
if not not_subbed:
    ...
    await message.answer("Siz hali hamma kanallarga obuna bo'lmadingiz. Iltimos obuna bo'lib qaytadan tekshiring:\n" + "\n".join(not_subbed))
